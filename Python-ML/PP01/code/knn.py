...
class KNN:
    ...
    def classifyWithAllK(self, testData):
        ...
        '''
        self.testingData = []                             # A list that will hold the data procured by testing
        ...
        if self.tuning_k == None:
            ...
            self.testingData.append((self.k, testingError))
        else:
            tuningKindex = 0
...
#                print "Testing error was: " + str(testingError) + "."
            ...
            for kVal in self.tuning_k:
                ...
                classification = self.classify(testData, kVal)
                testingError = np.mean ( (testLabs * classification) < 0)
                print "Testing error was: " + str(testingError) + "."
                self.testingData.append((kVal, testingError))
